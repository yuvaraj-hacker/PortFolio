                    ...
                    <div className='grid md:grid-cols-5  md:gap-5 md:pl-14  '>
                        ...
                        <div className='md:col-span-2  text-left flex flex-col justify-between'>
                            ...
                            <div>
                                ...
                                <Link to='/folsum-pulse'>
                                    <div className='flex w-fit p-2 rounded-t-2xl rounded-bl-2xl px-5 ml-auto bg-gradient-to-r cursor-pointer relative left-[1px] top-[2px] from-[#195259] to-green-200 items-center group'>
