    ...
    return (
        <>
            <section className='bg-white'>
                ...
                <section className="flex justify-center items-center bg-center bg-cover   bg-no-repeat md:rounded-br-[15rem] rounded-br-[8rem] 3xl:h-[70vh] py-10  " style={{ backgroundImage: `url(${'/assets/images/seventh/inbabackground.png'})` }}>
