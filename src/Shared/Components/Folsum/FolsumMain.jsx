...
function FolsumMain() {
    return (
        <>
                    ...
                    <div className='grid lg:grid-cols-2 grid-cols-1 gap-5 items-center' >
                        ...
                        <div className='  mx-auto'>
                            ...
                            <div className='flex relative  lg:top-52'>
                                <img className=' ' src='/assets/images/Fourth/folsummain.png' alt="" />
                                <img className=' absolute xl:-right-1/3 lg:-right-12 md:-right-1/4   xl:w-auto w-52  top-48 sm:block hidden  xl:top-44' src='/assets/images/Fourth/folsummain2.png' alt="" />
                            </div>
                ...
                <div className='max-w-[90rem] mx-auto px-5'>
                    <div className='grid lg:grid-cols-4 gap-10 items-center'>
                        <div className='relative col-span-2 space-y-3 '>
                            ...
                            <svg class="sparkling-star absolute -top-10  right-28 " width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <img className='absolute -top-1/3 -left-0 w-60  md:block hidden  ' src="/assets/images/Fourth/sec2.png" alt="" />
                            <img className='absolute -bottom-1/3  -right-0 md:block hidden  w-60' src="/assets/images/Fourth/sec3.png" alt="" />
                        </div>
                        <div className='md:space-y-5 col-span-2 md:text-base text-sm space-y-3 text-justify'>
                            <p> Folsom Pulse is a dynamic community and lifestyle platform designed to connect residents with local events,
                                services, and news, fostering a vibrant and engaged community. Our 8-member team collaborated to develop
                                this user-centric platform using modern web technologies, including Next.js, Tailwind CSS, and AWS,
                            ...
                            <p>
                                ...
                                appealing platform that makes navigating community resources effortless. Leveraging Next.js,
                                we built a fast and responsive interface, while Tailwind CSS enabled us to design a clean and
                                modern aesthetic. AWS powered the back end, ensuring reliable data management and robust cloud
                            ...
                            <p>Key features include real-time updates, an event calendar, service directories,
                                ...
                                across devices.</p>
                            <p>
                                Folsom Pulse reflects our commitment to creating a technology-driven solution that enhances
            ...
            <section class="image-scroll-container lg:mt-96 mt-24">
                <div class="image-scroll">
                    <img src="/assets/images/Fourth/new1.png" alt="" />
                    <img src="/assets/images/Fourth/new2.png" alt="" />
                    <img src="/assets/images/Fourth/new3.png" alt="" />
                    <img src="/assets/images/Fourth/new4.png" alt="" />
                    <img src="/assets/images/Fourth/new5.png" alt="" />
