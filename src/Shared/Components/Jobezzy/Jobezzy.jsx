    ...
    return (
        <>
            <section className='px-5  pr-6'>
                <section className="max-w-[90rem]   mx-auto  bg-[url('/assets/images/Second/jobezzy.png')] bg-center bg-cover border-2 rounded-t-[3.5rem] rounded-bl-[3.5rem]  w-full ">
                    <div className='grid md:grid-cols-5  md:gap-5 md:pl-14  '>
                        ...
                        <div className='text-left md:col-span-2   md:p-0 p-2 text-white flex flex-col justify-between'>
                            <div className=' md:space-y-6 space-y-3   lg:mt-10 p-2  pr-5'>
                                ...
                                <p className="lg:text-4xl md:text-2xl text-lg  font-bold">MOBILE WEB APP</p>
